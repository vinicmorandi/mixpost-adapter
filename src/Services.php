...
use SaguiAi\MixpostAdapter\ServiceForm\GoogleServiceForm;
use SaguiAi\MixpostAdapter\ServiceForm\LinkedinServiceForm;
use SaguiAi\MixpostAdapter\ServiceForm\PinterestServiceForm;
use SaguiAi\MixpostAdapter\ServiceForm\TenorServiceForm;
use SaguiAi\MixpostAdapter\ServiceForm\TikTokServiceForm;
use SaguiAi\MixpostAdapter\ServiceForm\TwitterServiceForm;
use SaguiAi\MixpostAdapter\ServiceForm\UnsplashServiceForm;
...
class Services
{
    ...
    public function services(?string $name = null): array|string|null
    {
        $services = [
            ...
            'google' => GoogleServiceForm::class,
            'twitter' => TwitterServiceForm::class,
            'linkedin' => LinkedinServiceForm::class,
            'tiktok' => TikTokServiceForm::class,
            'pinterest' => PinterestServiceForm::class,
